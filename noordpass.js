	OpenLayers.Control.Click = OpenLayers.Class(OpenLayers.Control, {
		...
		, trigger : function (evt) {
			...
			popup.contentHTML = link + "<br><img src='zuurstok.gif'>";
	...
	, update : function (options) {
		...
		if (this.layer && this.layer.map && this.layer.map.getZoom() < this.zoom_data_limit) {
			...
			if (this.layer.visibility == true) {
				++load_counter;
				setStatusText("<img src='zuurstok.gif'>");
				zoom_valid = true;
	...
	//	alert(name);
	name = name.replace("#l#", "<img style='vertical-align: middle;background-color: " + color + ";' src='line.gif'>&nbsp");
	name = name.replace("#dl#", "<img style='vertical-align: middle;background-color: " + color + ";' src='lineline.gif'>&nbsp");
	name = name.replace("#d#", "<img style='vertical-align: middle;background-color: " + color + ";' src='dots.gif'>&nbsp");
	name = name.replace("#c#", "<img style='vertical-align: middle;background-color: " + color + ";' src='tcircle.gif'>&nbsp");
...
//--- dit blok is nieuw -----------------------------
	...
	name = name.replace("#d#", "<img style='vertical-align: middle;background-color: " + color + ";' src='dots.gif'>&nbsp");
	name = name.replace("#c#", "<img style='vertical-align: middle;background-color: " + color + ";' src='tcircle.gif'>&nbsp");
	name = name.replace("#co#", "<img style='vertical-align: middle;background-color: " + color + ";' src='tocircle.gif'>&nbsp");
